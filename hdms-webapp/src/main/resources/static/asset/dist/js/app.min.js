...
app.config(["$controllerProvider", "$compileProvider", "$filterProvider", "$provide", function (t, e, n, r) {
    app.controller = t.register,
        app.directive = e.directive,
        app.filter = n.register,
        app.factory = r.factory,
        app.service = r.service,
        app.constant = r.constant,
        app.value = r.value
}]),
window.require &&
function (t) {
    ...
    app.config(["$translateProvider", function (t) {
        ...
        e[crsf.headerName] = crsf.token,
            t.defaults.headers.post = e,
    ...
    app.run(["$rootScope", "$state", "$stateParams", "$http", "Messager", function (t, e, n, r, s) {
        ...
        n.html5Mode(!0),
            e.otherwise("/index/directory/enterprise"),
            e.when("/index/document/{document}", ["$state", "$match", "$rootScope", function (t, e, n) {
                n.fid = e.document
            }]),
            t.state("favorites", {
                url: "/index/favorites",
    ...
    app.controller("AppCtrl", ["$rootScope", "$scope", "toaster", "FileSystem", "Messager", "$http", "$modal", "$location", "$state", "environment", "WebUploader", "Dropbox", "FileOperation", function (t, e, n, r, s, i, o, l, a, c, d, p, u) {
        e.ie9 = /msie 9/.test(window.navigator.userAgent.toLowerCase()),
            e.supportWebkitDirectory = "webkitdirectory" in HTMLInputElement.prototype,
            e.showQueue = !1,
            t.toaster = n,
            t.files = [],
            ...
            t.openDetail = !0,
            t.appSetting = c.appSetting,
            t.toggleDetail = function () {
            ...
            u.init(e),
            t.user = c.user,
            t.organization = c.user.organization,
            t.space = c.space,
            t.space.quotaPrecent = t.space.used / t.space.quota,
            t.mounts = c.mounts,
            t.mountAliases = {};
        ...
        if (e.$on("$stateChangeStart", function (n, r, s, i) {
            t.module = r.name,
            !0 === e.user.changePassword && "changePassword" !== r.name && (n.preventDefault(), a.go("changePassword"))
        }), t.mediaType = {
            avi: {
                icon: "asset/img/file/file_video.png",
                type: "video"
            },
            bmp: {
                icon: "asset/img/file/file_pic.png",
                type: "image"
            },
            png: {
                icon: "asset/img/file/file_pic.png",
            ...
            csv: {
                icon: "asset/img/file/file_csv.png",
                type: "office"
            },
            doc: {
                icon: "asset/img/file/file_word.png",
                type: "office"
            },
            docx: {
                icon: "asset/img/file/file_word.png",
            ...
            xls: {
                icon: "asset/img/file/file_excel.png",
                type: "office"
            },
            xlsx: {
                icon: "asset/img/file/file_excel.png",
            ...
            ppt: {
                icon: "asset/img/file/file_ppt.png",
                type: "office"
            },
            pptx: {
                icon: "asset/img/file/file_ppt.png",
            ...
            pdf: {
                icon: "asset/img/file/file_pdf.png",
                type: "pdf"
            },
            exe: {
                icon: "asset/img/file/file_exe.png",
                type: "unknown"
            },
            html: {
                icon: "asset/img/file/file_code.png",
                type: "code"
            },
            xml: {
                icon: "asset/img/file/file_code.png",
            ...
            css: {
                icon: "asset/img/file/file_css.png",
                type: "code"
            },
            mp4: {
                icon: "asset/img/file/file_video.png",
            ...
            mp3: {
                icon: "asset/img/file/file_music.png",
                type: "audio"
            },
            ogg: {
                icon: "asset/img/file/file_music.png",
            ...
            txt: {
                icon: "asset/img/file/file_txt.png",
                type: "txt"
            },
            rar: {
                icon: "asset/img/file/file_zip.png",
                type: "unknown"
            },
            zip: {
                icon: "asset/img/file/file_zip.png",
            ...
            chm: {
                icon: "asset/img/file/file_chm.png",
                type: "unknown"
            }
        }, e.onSearchKeyDown = function (t) {
            13 === t.keyCode && e.search()
        }, e.search = function (t) {
            e.keyword && a.go("search", {
                keyword: e.keyword
            })
            ...
            e ? (t.mountAlias = t.mountAliases[e.mount], t.mount = t.mounts[t.mountAlias], t.router = e.id, t.driectoryName = e.name) : "my" === t.mountAlias ? t.driectoryName = "个人文档" : t.driectoryName = "企业文档",
                t.current = e
        }, t.isAdmin = function () {
            ...
            var n;
            if (!e) return null;
            if ("directory" === e.type) n = Util.isPrivate(e) ? "asset/img/private_folder.png" : "asset/img/public_folder.png";
            else {
                var r = t.getExt(e);
                if (!r) return;
                r = r.toLowerCase();
            ...
            e.mode = t || ("list" === e.mode ? "block" : "list"),
                e.user.mode = e.mode
        }, e.changeSort = function (t) {
            e.sortField === t ? e.sortDesc = !e.sortDesc : (e.sortField = t, e.sortDesc = !0),
                e.sortFields = ["type", t],
                e.user.sortField = e.sortField,
                e.user.sortDesc = e.sortDesc
        }, e.changeDesc = function () {
            e.sortDesc = !e.sortDesc,
                e.user.sortDesc = e.sortDesc
        }, t.open = function (e, n) {
            "directory" === e.type ? a.go("directory", {
                directory: e.id
            }) : (t.fid = e.id, l.path("/index/document/" + e.id), n && n.stopPropagation())
        }, c.notice) {
            var f = c.notice;
        ...
        n.get("/conf/permission").success(function (t) {
            ...
            e.ok = function () {
                ...
                n.post("/fs/permission/set", r).success(function (t) {
                    e.saving = !1,
                        t.success ? (o.doSuccess("权限已设置"), s.close()) : o.doError("权限设置失败:" + t.message)
                }).error(function (t, n) {
                    e.saving = !1,
                        o.doError("权限设置失败:" + (t.message || n))
                })
            },
            e.close = function () {
                s.dismiss("cancel")
    ...
    app.controller("AuthorizeCtrl", ["$rootScope", "$scope", "$http", "Messager", "$modal", "$modalInstance", "id", function (t, e, n, r, s, i, o) {
        ...
        e.select = function (t, n) {
            n.stopPropagation(),
                e.current !== t ? e.current = t : e.current = null
        },
            e.condition = {},
            e.changeConditionPermission = function (t) {
                e.condition.permission = t
            },
            e.load = function () {
                e.loading = !0,
                    n.get("/fs/authorize/list", {
                        params: {
                            documentId: o
                        }
                    }).success(function (t, n, r, s) {
                        e.loading = !1,
                            t.success ? e.authorizes = t.data : (e.toaster.pop("error", t.message), e.error = t.message)
                    }).error(function (t, n) {
                        e.loading = !1,
                            e.error = t.message,
                            e.toaster.pop("error", "加载失败：" + n)
                    })
            },
            e.count = function (t) {
            ...
            e.update = function (t) {
                function s() {
                    ...
                    if (!0 === t.inherited) {
                        ...
                        1 === e.current.ownerType ? s.userIds = [e.current.owner] : s.departmentIds = [e.current.owner],
                            n.post("/fs/authorize/add", s).success(function (t) {
            ...
            e.remove = function (t, s) {
                ...
                s.stopPropagation(),
                    r.confirm("提示", "确定要删除?").then(function () {
                        i(t)
                    })
            },
            e.ok = function () {
    ...
    app.controller("AuthorizeAddCtrl", ["$rootScope", "$scope", "$http", "$modal", "$modalInstance", "permissions", "id", function (t, e, n, r, s, i, o) {
        e.loading = !1,
            ...
            e.selectedDepartmentIds = [],
            e.addDepartment = function (t) {
            ...
            e.search = function () {
                e.condition && (e.searching = !0, e.loading = !0, n.get("/member/search", {
                    params: {
                        condition: e.condition
                    }
                }).success(function (t, n, r, s) {
                    e.loading = !1,
                        t.success ? e.searchResult = t.data : e.toaster.pop("error", "提示", t.message)
                }).error(function (t, n) {
                    e.loading = !1,
                        e.toaster.pop("error", "提示", "加载失败：" + n)
                }))
            },
            e.ok = function () {
                var t = {
                ...
                e.saving = !0,
                    n.post("/fs/authorize/add", t).success(function (t) {
                        e.saving = !1,
                            t.success ? (r.doSuccess("权限已添加"), s.close()) : r.doError("添加权限失败：" + t.message)
                    }).error(function (t, n) {
                        e.saving = !1,
                            r.doError("添加权限失败：" + (t.message || n))
                    })
            },
            e.loadMember = function (t) {
                e.loading = !0,
                    n.get("/member/list", {
                        ...
                        e.loading = !1,
                            t.success ? (e.users = t.data.users, e.departments = t.data.departments) : e.toaster.pop("error", t.message)
                    }).error(function (t, n) {
                        e.loading = !1,
                            e.toaster.pop("error", "加载失败：" + n)
                    })
    ...
    app.controller("ChangePasswordCtrl", ["$scope", "$http", function (t, e) {
        t.check = function () {
            ...
            /\d/.test(t.newPassword) && e++,
            /[a-z]/.test(t.newPassword) && e++,
            /[A-Z]/.test(t.newPassword) && e++,
            /\W/.test(t.newPassword) && e++,
                t.strength = e
        },
            t.submit = function () {
    ...
    app.controller("DirectoryCtrl", ["$rootScope", "$scope", "$http", "$state", "$location", "$modal", "$stateParams", "Messager", "FileSystem", function (t, e, n, r, s, i, o, l, a) {
        ...
        var p = o.directory,
            u = t.mounts[p];
        u && (t.mount = u, t.mountAlias = p, p = null),
            ...
            e.load = function (n) {
                ...
                a.load(r, n).then(function (n) {
                    e.files = n.files,
                        e.path = n.path,
                        e.activities = n.activities,
                        e.authorizes = n.authorizes,
                    n.current && (n.current.permissions = n.permissions),
                        t.setCurrent(n.current),
                        e.loading = !1
                }, function (t) {
                    e.error = t,
                        e.toaster.pop("error", "加载文件失败", t),
                        e.loading = !1
                })
            },
            ...
            e.loadAuthorizes = function () {
                n.get("/fs/authorize/list", {
                    params: {
                        documentId: e.current.id
                    }
                }).success(function (t, n, r, s) {
                    e.loading = !1,
                        t.success ? e.authorizes = t.data : e.toaster.pop("error", t.message)
                }).error(function (t, n) {
                    e.loading = !1,
                        e.toaster.pop("error", "加载失败：" + n)
                })
            ...
            e.addFavorite = function (e, n) {
                n.stopPropagation(),
                    a.addFavorite(e).then(function (n) {
                        t.toaster.success({
                            title: "已收藏"
                        }),
                            e.favoriteId = n.data
            ...
            e.removeFavorite = function (e, n) {
                n.stopPropagation(),
                    a.removeFavorite(e).then(function (n) {
                        t.toaster.success({
                            title: "收藏已取消"
                        }),
                            e.favoriteId = null
            ...
            e.addSelection = function (t) {
                e.selection.push(t),
                    t.selected = !0,
                !0 === t.locked && e.lockedSelectionCount++,
                e.selection.length === e.files.length && (e.isSelectAll = !0)
            },
            e.removeSelection = function (t) {
                e.selection.splice(e.selection.indexOf(t), 1),
                    t.selected = !1,
                !0 === t.locked && e.lockedSelectionCount++,
                    e.isSelectAll = !1
            },
            ...
            e.select = function (t, n, r) {
                if (r && "block" === e.mode && !r.ctrlKey && e.clearSelection(), r && r.stopPropagation(), !t.selected || n !== t.selected) return $(".app-ctrl").scrollTop(0),
                    !1 === (n = n || !t.selected || !t.selected) ? e.removeSelection(t) : e.addSelection(t)
            },
            e.removeAuthorize = function (t, r) {
                function s(t) {
                    var r = e.toaster.wait("正在删除..."),
                        s = n.post("/fs/authorize/remove/" + t.id, {});
                ...
                r.stopPropagation(),
                    l.confirm("提示", "确定要删除?").then(function () {
                        s(t)
                    })
            },
            ...
            e.updatePermission = function (t) {
                function r() {
                    ...
                    if (!0 === e.selectedAuthorize.inherited) {
                        ...
                        1 === e.selectedAuthorize.ownerType ? s.userIds = [e.selectedAuthorize.owner] : s.departmentIds = [e.selectedAuthorize.owner],
                            n.post("/fs/authorize/add", s).success(function (t) {
            ...
            e.remove = function (n) {
                n || 0 === (n = e.selection).length && l.alert("提示", "请选择要删除的文件"),
                    t.remove(n, function () {
                        e.reload()
                    })
            },
            e.lock = function (n) {
                n || (n = e.selection[0]) || l.alert("提示", "请选择要锁定的文件"),
                    t.lock(n, function () {
                        e.reload()
                    })
            },
            e.unlock = function (n) {
                n || (n = e.selection[0]) || l.alert("提示", "请选择要解锁的文件"),
                    t.unlock(n, function () {
                        e.reload()
                    })
            },
            e.rename = function (n) {
                n || (n = e.selection[0]),
                n || l.alert("提示", "请选择要重命名的文件"),
                    t.rename(n, function (t, e) {
                        n.name = e
                    })
            },
            ...
            e.updateDesc = function () {
                t.updateDescription(e.current, function () {}, function () {})
            },
            e.createDirectory = function () {
                l.prompt("新建文件夹", "", "").then(function (n) {
                    var r = e.toaster.wait({
                            title: "正在新建文件夹"
                        }),
                        s = {
                            mount: t.mount.id,
                    ...
                    e.current && (s.parent = e.current.id),
                        a.createDirectory(s).then(function () {
                            r.doSuccess({
                                type: "success",
                                title: "新建文件夹成功"
                            }),
            ...
            e.showContextMenu = function (t, n) {
                var r = angular.element("#directoryOperationContextMenu"),
                    s = angular.element(window.document);
                e.selected = t,
                    e.select(t, !0, n);
                var i = n.pageY,
                    o = n.pageX;
                i + r.height() > s.height() && (i -= r.height()),
                o + r.width() > s.width() && (o -= r.width()),
                    r.css({
                        top: i,
                        left: o
                    }),
            ...
            e.showPermissionContextMenu = function (t, n) {
                var r = angular.element("#permissionContextMenu"),
                    s = angular.element(window.document);
            ...
            e.showContainerContextMenu = function (t) {
                var e = angular.element("#containerContextMenu"),
                    n = angular.element(window.document),
                    r = t.pageY,
                    s = t.pageX;
                r + e.height() > n.height() && (r -= e.height()),
                s + e.width() > n.width() && (s -= e.width()),
                    e.css({
                        top: r,
                        left: s
                    }),
            ...
            e.reset = function () {
                e.selection = [],
                    e.isSelectAll = !1,
                    e.lockedSelectionCount = !1
            },
            $(document).on("keydown", d),
            $(window).on("click", c),
            e.$on("$destroy", function () {
                $(window).unbind("click", c),
    ...
    app.controller("FileDetailCtrl", ["$rootScope", "$scope", "$http", "FileSystem", "Messager", "$location", "$modal", "$modalInstance", "id", function (t, e, n, r, s, i, o, l, a) {
        ...
        e.supportFullScreen = d,
            ...
            e.addReview = function (t) {
                ...
                n.post("/review/add", {
                    content: t,
                    documentId: e.file.id
                }).success(function (t) {
                    if (t.success) {
                        r.doSuccess("评论发表成功");
                        var n = t.data;
                        n.name = e.user.name,
                            n.avatar = e.user.avatar,
                            e.reviews.push(n)
            ...
            e.load = function (r) {
                e.loading = !0,
                    n.get("/fs/document/" + r).success(function (n) {
                        e.loading = !1,
            ...
            e.setCurrent = function (r) {
                e.current = r,
                    e.current.media = e.getMediaType(e.current),
                    e.current.icon = t.getIcon(e.current),
                "code" === e.current.media && (e.cmOption = {
                    lineNumbers: !0,
                    indentWithTabs: !0,
                    mode: e.getExt(r),
                    readOnly: !0,
            ...
            e.load(a),
            e.showDocumentContextMenu = function (t, n) {
                var r = angular.element("#documentOperationContextMenu"),
                    s = angular.element(window.document);
                e.selected = t;
                var i = n.pageY,
                    o = n.pageX;
    ...
    app.controller("FileMoveCtrl", ["$rootScope", "$scope", "Messager", "$modalInstance", "data", function (t, e, n, r, s) {
        ...
        e.isRepeat = !1,
            ...
            e.setTarget = function (t) {
                var n = s.files[0].parent,
                    r = s.files[0].mount;
                if (n && n === t.id ? e.isRepeat = !0 : n || t.id || r !== t.mount ? e.isRepeat = !1 : e.isRepeat = !0, !0 === e.isRepeat) return e.target = null,
                    void(e.paths = null);
                var i = [];
                for (e.target = t, i.push(t.name); t.$parent && !t.$parent.$root;) t = t.$parent,
                    i.push(t.name);
                i.reverse(),
                    e.paths = i.join(" / ")
            },
    ...
    app.controller("FileCopyCtrl", ["$rootScope", "$scope", "Messager", "$modalInstance", "data", function (t, e, n, r, s) {
        e.ok = function () {
            ...
            e.setTarget = function (t) {
                var n = [];
                for (e.target = t, n.push(t.name); t.$parent && !t.$parent.$root;) t = t.$parent,
                    n.push(t.name);
                n.reverse(),
                    e.paths = n.join(" / ")
            },
    ...
    app.controller("FileTagCtrl", ["$scope", "$http", "$modalInstance", "Messager", "FileSystem", "file", function (t, e, n, r, s, i) {
        t.tags = [],
            t.file = i,
        i.tags && (t.tags = i.tags.split(",")),
            t.remove = function (e) {
                t.tags.splice(t.tags.indexOf(e), 1),
                    i.tags = t.tags.join(","),
                    t.save()
            },
            t.add = function () {
    ...
    app.controller("FileSendCtrl", ["$scope", "$http", "files", "$modal", "$modalInstance", "Messager", function (t, e, n, r, s, i) {
        t.files = n,
            t.remove = function (e) {
                t.files.splice(t.files.indexOf(e), 1),
                0 === t.files.length && s.dismiss("cancel")
            },
            t.users = [],
            t.userIds = {},
            t.addReceiver = function () {
                r.open({
            ...
            t.removeReceiver = function (e) {
                t.users.splice(t.users.indexOf(e), 1),
                    delete t.userIds[e.id]
            },
            t.ok = function () {
                var n = t.toaster.wait("正在发送");
                t.sending = !0;
                var r = Util.Array.copyProperty(t.files, "id"),
                    i = Util.Array.copyProperty(t.users, "id");
                e.post("/message/send", {
                    files: r,
                    receivers: i,
                    content: t.content
                    ...
                    t.sending = !1,
                        e.success ? (n.doSuccess("发送成功"), s.close()) : n.doError("发送失败:" + e.message)
                }).error(function (t, e) {
    ...
    app.controller("DropboxCtrl", ["$scope", "$http", "data", "$modalInstance", "Messager", function (t, e, n, r, s) {
        t.files = [];
        for (var i = 0; i < n.files.length; i++) console.log(n.files),
            t.files.push(n.files[i]);
        t.treeConfig = {
            "load-url": "/fs/folder",
            "load-asyn": !0,
        ...
        t.directory || (t.directory = {
            ...
            t.remove = function (e) {
                t.files.splice(t.files.indexOf(e), 1),
                0 === t.files.length && r.dismiss("cancel")
            },
            t.ok = function () {
                var e = {
    ...
    app.controller("FavoritesCtrl", ["$rootScope", "$scope", "$http", "$state", "$location", "$modal", "Messager", "FileSystem", function (t, e, n, r, s, i, o, l) {
        ...
        t.module = "favorites",
            e.load = function () {
                e.loading = !0,
                    n.get("/fs/favorites").success(function (t) {
                        e.loading = !1,
                            t.success ? e.files = t.data : e.error = t.message
                    }).error(function (t, n) {
                        e.error = t.message || n,
                            e.toaster.pop("error", t.message || n),
                            e.loading = !1
                    })
            },
            e.$on("$viewContentLoaded", function () {
            ...
            e.remove = function (n) {
                n || 0 === (n = e.selection).length && o.alert("提示", "请选择要删除的文件"),
                    t.remove(n, function () {
                        e.reload()
                    })
            },
    ...
    app.controller("MessagesCtrl", ["$scope", "$http", "$rootScope", "$location", "$state", function (t, e, n, r, s) {
        t.message || t.$on("$viewContentLoaded", function () {
            ...
            t.load = function () {
                t.loading = !0,
                    e.get("/message/list").success(function (e) {
                        t.loading = !1,
                            e.success ? n.messages = e.data : t.error = "加载消息失败:" + e.message
                    }).error(function (e, n) {
                        t.loading = !1,
                            t.error = "加载消息失败:" + (e.message || n)
                    })
            }
    }]),
    app.controller("ProfileCtrl", ["$scope", "$http", function (t, e) {
        t.save = function () {
            ...
            t.upload = function () {
                var e = angular.element("#avatarInput")[0].files,
                    n = new FormData;
                n.append("avatar", e[0]);
                var r = new XMLHttpRequest;
                r.onload = function (e) {
                    if (t.uploading = !1, 200 !== r.status) t.result = {
                        success: !1,
                        message: "上传失败：请稍候再试：" + r.status
                    };
                    else {
                    ...
                    r.open("POST", "/user/upload/avatar"),
                    r.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
                    r.setRequestHeader(crsf.headerName, crsf.token),
                    t.uploading = !0,
                    r.send(n)
            }
    }]),
    app.controller("RecentsCtrl", ["$rootScope", "$scope", "$http", "$state", "$location", "$modal", "Messager", "FileSystem", function (t, e, n, r, s, i, o, l) {
        ...
        t.module = "recent",
            e.load = function () {
                e.loading = !0,
                    n.get("/fs/recent").success(function (t) {
                        e.loading = !1,
                            t.success ? e.files = t.data : e.error = t.message
                    }).error(function (t, n) {
                        e.error = t.message || n,
            ...
            e.removeRecent = function () {
                o.confirm("提示", "确定要删除?").then(function () {
                    var r = t.toaster.wait("正在删除..."),
                        s = Util.Array.copyProperty(e.selection, "id").join(",");
                    n.post("/recent/remove", {
                        hcoId: s
                    }).success(function (t) {
            ...
            e.select = function (t, n, r) {
                r && "block" == e.mode && !r.ctrlKey && e.clearSelection(),
                r && ($(".app-ctrl").scrollTop(0), r.stopPropagation()),
                t.selected && n === t.selected || (!1 === (n = n || !t.selected || !t.selected) ? e.removeSelection(t) : e.addSelection(t))
            },
            e.onContainerClick = function () {
                "block" === e.mode && e.clearSelection()
            },
    ...
    app.controller("RecycleCtrl", ["$rootScope", "$scope", "$http", "$state", "$location", "$modal", "Messager", function (t, e, n, r, s, i, o) {
        ...
        t.module = "recycle",
            e.load = function () {
                e.reset(),
                    e.loading = !0,
                    n.get("/recycle/list").success(function (t) {
                        e.loading = !1,
                            t.success ? e.files = t.data : e.error = t.message
                    }).error(function (t, n) {
                        e.error = t.message || n,
            ...
            e.revert = function () {
                o.confirm("提示", "确定要恢复?").then(function () {
                    var r = t.toaster.wait("正在恢复..."),
                        s = Util.Array.copyProperty(e.selection, "id");
                    n.post("/recycle/revert", {
                        documentIds: s
                    }).success(function (t) {
            ...
            e.destroy = function () {
                o.confirm("提示", "确定要彻底删除?").then(function () {
                    var r = Util.Array.copyProperty(e.selection, "id"),
                        s = t.toaster.wait("正在删除...");
                    n.post("/recycle/delete", {
                        documentIds: r
                    }).success(function (t) {
    ...
    app.controller("SearchCtrl", ["$rootScope", "$scope", "$http", "$state", "$stateParams", "$location", "$modal", "Messager", "FileSystem", function (t, e, n, r, s, i, o, l, a) {
        t.module = "search",
            ...
            e.load = function () {
                e.loading = !0,
                    ...
                    n.get("/fs/search", {
                        ...
                        e.loading = !1,
                            t.success ? (e.result = t.data, e.pagination.pages = t.data.pages) : e.error = t.message
                    }).error(function (t, n) {
                        e.error = t.message || n,
                            e.toaster.pop("error", t.message || n),
                            e.loading = !1
            ...
            e.addSelection = function (t) {
                e.selection.push(t),
                    t.selected = !0,
                e.selection.length === e.result.records.length && (e.isSelectAll = !0)
            },
            e.removeSelection = function (t) {
                e.selection.splice(e.selection.indexOf(t), 1),
                    t.selected = !1,
    ...
    app.controller("SelectUserCtrl", ["$rootScope", "$scope", "$http", "$modal", "$modalInstance", "options", function (t, e, n, r, s, i) {
        e.loading = !1,
            ...
            e.search = function () {
                e.condition && (e.searching = !0, e.loading = !0, n.get("/user/search", {
                    params: {
                        condition: e.condition
                    }
                }).success(function (t, n, r, s) {
                    e.loading = !1,
                        t.success ? e.result = t.data : e.toaster.pop("error", "提示", t.message)
                }).error(function (t, n) {
                    e.loading = !1,
                        e.toaster.pop("error", "提示", "加载失败：" + n)
                }))
            ...
            e.loadUser = function (t) {
                e.loading = !0,
                    n.get("/user/list", {
                        ...
                        e.loading = !1,
                            console.log(t),
                            t.success ? e.users = t.data : e.toaster.pop("error", t.message)
                    }).error(function (t, n) {
                        e.loading = !1,
                            e.toaster.pop("error", "加载失败：" + n)
                    })
    ...
    app.factory("Dropbox", ["$rootScope", "FileSystem", "$modal", function (t, e, n) {
        ...
        return r.init = function (t) {
            ...
            var r = document.getElementById("dropbox"),
                s = !1;
            document.addEventListener("mousedown", function () {
                ...
                r.addEventListener("dragenter", function (t) {
                    e(t)
                }),
                ...
                r.addEventListener("drop", function (s) {
                    ...
                    i && i.length > 0 && n.open({
                        ...
                        for (var n = e.files, r = 0; r < n.length; r++) {
                            var s = n[r];
                            s.uploadContext = e.uploadContext,
                                t.webUploader.addFiles(s)
                        }
                    }, function () {})
                })
        },
    ...
    app.factory("FileOperation", ["$rootScope", "FileSystem", "$modal", "Messager", "$state", function (t, e, n, r, s) {
        ...
        return i.init = function (i) {
            i.openParent = function (t, e) {
                s.go("directory", {
                    directory: -1 !== t.parent ? t.parent : i.getMountAlias(t.mount)
                }),
                    e.stopPropagation()
            },
                t.open = function (e, n) {
                    "directory" === e.type ? s.go("directory", {
                        directory: e.id
                    }) : (t.fid = e.id, $location.path("/index/document/" + e.id), n && n.stopPropagation())
                },
                ...
                t.sendFile = function (t) {
                    angular.isArray(t) || (t = [t]),
                        ...
                        }).result.then(function (t) {}, function () {})
                },
                ...
                t.copy = function (t, r, s) {
                    n.open({
                        ...
                        e.copy(t, n.id, n.mount).then(function (t) {
                            ...
                            angular.isFunction(success) && success(t)
                        }, function (t) {
                            r.doError({
                                title: "复制失败",
                                body: t
                ...
                t.updateDescription = function (t, n, r) {
                    ...
                    e.updateDescription(t).then(function (t) {
                        ...
                        angular.isFunction(n) && n(t, name)
                    }, function (t) {
                        s.doError({
                            title: "修改失败",
                            body: t
                        }),
                        angular.isFunction(r) && r(t)
                    })
                },
    ...
    app.factory("FileSystem", ["$http", "$q", function (t, e) {
        ...
        return n.isPrivate = function (t) {
            ...
            n.download = function (n) {
                var r = e.defer(),
                    s = n.id;
                return angular.isArray(n) && (s = Util.Array.copyProperty(n, "id").join(",")),
                    t.get("/fs/download", {
                        params: {
                            id: s
                        }
            ...
            n.removeFavorite = function (n) {
                var r = e.defer(),
                    s = n.id;
                return s = angular.isArray(n) ? Util.Array.copyProperty(n, "id") : [s],
                    t.post("/favorite/remove", {
                        documentIds: s
                    }).success(function (t) {
                        t.success ? r.resolve(t) : r.reject(t.message)
                    }).error(function (t, e) {
            ...
            n.updateDescription = function (n) {
                var r = e.defer();
                return t.post("/fs/updateDescription", {
                    id: n.id,
            ...
            n.copy = function (n, r, s) {
                var i = e.defer();
                return n = angular.isArray(n) ? Util.Array.copyProperty(n, "id") : [n.id],
                    t.post("/fs/copy", {
                        documentIds: n,
                        parent: r,
                        mount: s
            ...
            if (t.onUploadFileChange = function () {
                ...
                WebUploader.Uploader.register({
                    ...
                    beforeSendFile: function (t) {
                        ...
                        return t.setStatus("md5", "正在校验文件"),
                            n.webUploader.md5File(t, 0, 10485760).progress(function (e) {
                                t.md5Percentage = e
                            }).then(function (n) {
                                t.md5 = n,
                                    e.verify(t).then(function (e) {
                                        e.success ? r.resolve() : t.setStatus("error", e.message || "文件校验失败")
                                    }, function (e) {
                                        t.setStatus("error", e.message),
                                            r.reject()
                                    })
                            }),
                            r.promise()
                ...
                i.on("uploadBeforeSend", function (t, e, n) {
                    e.md5 = t.file.md5,
                        e.parent = t.file.parent,
                        e.mount = t.file.mount,
                        e.master = t.file.master,
                    ...
                    i.on("fileQueued", function (e) {
                        if (e.source.source.uploadContext) {
                            ...
                            e.mount = r.mount,
                                ...
                                e.parent = r.parent,
                                e.path = r.path,
                                e.mountAlias = r.mountAlias
                        } else e.mount = t.mount.id,
                            t.current ? (e.parent = t.current.id, e.path = t.current.name) : "enterprise" === t.mountAlias ? e.path = "企业文档" : e.path = "我的文档",
                            e.mountAlias = t.mountAlias;
                        e.icon = n.getIcon(e),
                            e.on("statuschange", function (t) {
                                e.status = t
                            }),
                            t.files.push(e),
                            n.showQueue = !0,
                    ...
                    i.on("uploadProgress", function (t, e) {
                        t.uploadPercentage = e.toFixed(2),
                            t.setStatus("progress", "正在上传：" + 100 * t.uploadPercentage + "%"),
                            n.$apply()
                    }),
                    i.on("uploadSuccess", function (e, s) {
                        r(),
                            !0 === s.success ? (n.$broadcast("$fileUploaded", s.data), e.setStatus("success", "上传成功")) : e.setStatus("error", "上传失败"),
                            t.$apply()
                    }),
                    i.on("uploadError", function (e, n) {
                        r(),
                            e.setStatus("error", n ? "系统异常，上传失败" : e.statusText),
                        n && t.$apply()
                    }),
                    i.on("uploadStart", function (t) {
                        t.setStatus("progress", "正在上传"),
                            r()
                    }),
                    i.on("uploadComplete", function (t) {
                        r(),
                        0 === n.uploadStats.progressNum && (n.showQueue = !1)
                    }),
                    n.webUploader = i
    ...
    angular.module("app").run(["$templateCache", function (t) {
        ...
        t.put("asset/tpl/app/authorize_add.html", '<div class=m-c>\r\n    <div class=modal-header>\r\n        <div class="pull-right col-md-6 no-padder">\r\n            <div class=input-group>\r\n                <input class=form-control ng-model=condition placeholder=搜索:用户名/姓名/拼音>\r\n                <div class=input-group-btn>\r\n                    <button type=button class="btn btn-default" ng-show=condition ng-click=clear();>\r\n                        <i class="glyphicon glyphicon-remove"></i>\r\n                    </button>\r\n                    <button type=button class="btn btn-default" ng-click=search();>\r\n                        <i class="glyphicon glyphicon-search"></i>\r\n                    </button>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <h4 class=modal-title style="line-height: 34px">\r\n            <i class="fa fa-user"></i>\r\n            添加协作者\r\n        </h4>\r\n\r\n    </div>\r\n    <div class="modal-body no-padder">\r\n        <div class=permission-user-body ng-show=!searching>\r\n            <div class="col-sm-6 permission-user-part b-r wrapper-sm">\r\n                <hc-tree tree-control=tree load-asyn=true on-init=onTreeInit() open-folder-icon="fa fa-users" folder-icon="fa fa-users" leaf-icon="fa fa-users" on-selection-change=loadMember(selection); load-url=/department/list></hc-tree>\r\n            </div>\r\n            <div class="col-sm-6 permission-user-part wrapper-sm">\r\n                <div class="wrapper-xl text-center" ng-show=loading>\r\n                    <img src=asset/img/loading.gif>\r\n                    <p class=m-t-sm>正在加载</p>\r\n                </div>\r\n                <div ng-repeat="dept in departments" class="wrapper-xs hover-bg" ng-show=!loading ng-click="addDepartment(dept,\'department\');">\r\n                    <img src=/asset/img/group.png class=img-circle style=height:30px alt=...>\r\n                    <span class=m-l-sm style="line-height: 30px">{{dept.name}}</span>\r\n                </div>\r\n                <div ng-repeat="user in users" class="wrapper-xs hover-bg" ng-show=!loading ng-click=addUser(user);>\r\n                    <img ng-src="{{user.avatar | resource}}" class=img-circle style=height:30px alt=...>\r\n                    <span class=m-l-sm style="line-height: 30px">{{user.name}}</span>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class="permission-user-body wrapper-sm" ng-show=searching>\r\n            <div class="col-md-4 wrapper-xs hover-bg" ng-repeat="department in searchResult.departments" ng-click=addDepartment(department);>\r\n                <img src=/asset/img/group.png class="img-circle pull-left" style=height:50px alt=...>\r\n                <div class=inline>\r\n                    <span class=m-l-sm style="line-height: 30px">{{department.name}}</span>\r\n                    <br>\r\n                    <span class="m-l-sm text-muted">{{department.code}}</span>\r\n                </div>\r\n            </div>\r\n            <div class="col-md-4 wrapper-xs hover-bg" ng-repeat="user in searchResult.users" ng-click=addUser(user);>\r\n                <img ng-src="{{user.avatar | resource}}" class="img-circle pull-left" style=height:50px alt=...>\r\n                <div class=inline>\r\n                    <span class=m-l-sm style="line-height: 30px">{{user.name}}</span>\r\n                    <br>\r\n                    <span class="m-l-sm text-muted">{{user.username}}</span>\r\n                </div>\r\n            </div>\r\n            <div class=col-sm-12 ng-show="(!searchResult.departments && !searchResult.users) || (searchResult.departments.length == 0 && searchResult.users.length == 0)">\r\n                <div class="wrapper-xs text-center">\r\n                    <i class="iconfont icon-empty"></i>\r\n                    <p class=m-t-sm>没有搜索匹配的结果</p>\r\n                </div>\r\n            </div>\r\n            <div class="col-sm-12 permission-user-part" ng-show=loading>\r\n                <div class="wrapper-xl text-center">\r\n                    <img ng-src="{{\'asset/img/loading.gif\' | resource}}">\r\n                    <p class=m-t-sm>正在加载</p>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class="wrapper-sm b-t" ng-hide="selectedUsers.length == 0 && selectedDepartments.length == 0">\r\n            <div class="permission-user-selected wrapper-sm text-center inline hover-bg" ng-repeat="department in selectedDepartments">\r\n                <button type=button class=close ng-click=removeDepartment(department)>\r\n                    <span aria-hidden=true>×</span>\r\n                </button>\r\n                <img src=/asset/img/group.png class=img-circle style=height:35px alt=...>\r\n                <div class="text-ellipsis m-t-xs" style="font-size: 12px">{{department.name}}</div>\r\n            </div>\r\n            <div class="permission-user-selected wrapper-sm text-center inline hover-bg" ng-repeat="user in selectedUsers">\r\n                <button type=button class=close ng-click=removeUser(user)>\r\n                    <span aria-hidden=true>×</span>\r\n                </button>\r\n                <img ng-src="{{user.avatar | resource}}" class=img-circle style=height:35px alt=...>\r\n                <div class="text-ellipsis m-t-xs" style="font-size: 12px">{{user.name}}</div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=modal-footer>\r\n        <form class="form-inline inline">\r\n            <div class=input-group>\r\n                <span class=input-group-addon>权限</span>\r\n                <select class="form-control wrapper-xs" ng-model=permission>\r\n                    <option ng-repeat="permission in permissions" value={{permission.id}}>{{permission.name}}</option>\r\n                </select>\r\n            </div>\r\n        </form>\r\n        <button type=button class="btn btn-primary" ng-click=ok() style="margin-left: 5px" ng-disabled="(selectedUsers.length == 0 && selectedDepartments.length == 0)|| !permission || saving">\r\n            <span ng-show=!saving>提交</span>\r\n            <span ng-show=saving>正在提交</span>\r\n        </button>\r\n        <button type=button class="btn btn-default" ng-click=close()>取消</button>\r\n    </div>\r\n</div>'),
            ...
            t.put("asset/tpl/app/shares.html", '<div class="wrapper-xl text-center">\r\n\t<i class="iconfont icon-info"></i>\r\n\t<p class=m-t-md>非常抱歉，社区版暂不支持此功能</p>\r\n</div>\r\n'),
